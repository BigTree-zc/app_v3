...
#ifndef LV_ATTRIBUTE_IMG_TEST2
#define LV_ATTRIBUTE_IMG_TEST2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_TEST2 uint8_t test2_map[] = {
